...
public class MainForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMark5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        txtMark5.setToolTipText("");
        ...
        lblMark5.setFont(new java.awt.Font("Tw Cen MT", 3, 18)); // NOI18N
        lblMark5.setForeground(new java.awt.Color(0, 153, 255));
        lblMark5.setText("Course Mark 5");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtMark5, javax.swing.GroupLayout.PREFERRED_SIZE, 56, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void BtnCalculateAverageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCalculateAverageActionPerformed
        ...
        double total = 0;
        final int NUM_MARKS = numbers.length;

        numbers[0] = Double.parseDouble(txtMark1.getText());
        numbers[1] = Double.parseDouble(txtMark2.getText());
        numbers[2] = Double.parseDouble(txtMark3.getText());
        numbers[3] = Double.parseDouble(txtMark4.getText());
        numbers[4] = Double.parseDouble(txtMark5.getText());

//        for (int i = 0; i <= (NUM_MARKS - 1); i = i + 1) {
//            String x = String.valueOf(i + 1);
//            String markLabel = "txtMark" + x;
//            numbers[i] = Double.parseDouble(markLabel.getText());
//        }
        for (int i = 0; i <= (NUM_MARKS - 1); i = i + 1) {
            total = total + numbers[i];
        }
        double averMark = total / NUM_MARKS;
